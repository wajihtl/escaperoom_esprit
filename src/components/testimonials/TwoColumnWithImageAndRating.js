...
const Row = tw.div`flex flex-col md:flex-row  items-center justify-self-center w-full`;
...
export default ({
  ...
  description = "Welcome to our team section! At ESPRIT, we believe that our success is driven by our talented and dedicated team. Our team is made up of individuals from diverse backgrounds and experiences who share a common passion for delivering exceptional results.",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
      ...
      customerTitle: "Data Science Department Chief, ESPRIT.",
    },
    {
      stars: 5,
      profileImageSrc:
